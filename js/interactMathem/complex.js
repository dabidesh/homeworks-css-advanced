...
getExpressions.onclick = () => {
  ...
  let z3 = 'нЕма';
  if (arrayComplexNumbers[4] != undefined && arrayComplexNumbers[5] != undefined) {
    z3 = '(' + arrayComplexNumbers[4].toString() + '+' + '(' +
  ...
  outZ1Z2Z3.value = z1 + ' ' + z2 + ' ' + z3;
  outZ1Z2Z3.style.width = outZ1Z2Z3.value.length + 'ch';
};
