...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype.run = function(archiveUrl, executable) {
      return new Dosbox.Mount(this.module, archiveUrl, {
        success: (function(_this) {
          return function() {
            var func, hide;
            _this.ui.updateMessage("Стартиране на " + executable);
            hide = function() {
    ...
    Dosbox.prototype.downloadScript = function() {
      ...
      this.ui.updateMessage('Сваляне js-dos');
      return new Dosbox.Xhr('https://js-dos.com/cdn/js-dos-v3.js', {
        success: (function(_this) {
          return function(script) {
            var func;
            _this.ui.updateMessage('Инициализиране dosbox');
            func = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Сваляне js-dos (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
...
(function() {
  Dosbox.UI = (function() {
    function UI(options) {
      ...
      this.start = $('<div class="dosbox-start">Цъкни за старт!');
      this.div.append(this.wrapper);
      this.wrapper.append(this.canvas);
      this.wrapper.append(this.loader);
      this.wrapper.append(this.overlay);
      this.overlay.append($('<div class="dosbox-powered">С помощта на библиотеката &nbsp;').append($('<a href="http://js-dos.com">js-dos.com')));
