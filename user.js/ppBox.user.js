...
(function () {
  ...
  function mishOver(event) {
    ...
    //GM_log(pos.x+'-'+pos.y)
    input.value = pos.x + '-' + pos.y + ' w=' + wh.x + ' h=' + wh.y

    inputElement.value = window.event.target.nodeName
  }
  ...
  var frag, input, input1, input2, minButon, kont, inputElement
  var flagDolu = false
  var flagMax = true
...
"
    ...
    minButon.setAttribute('title', 'Минимизирай')
    ...
    inputElement.style.fontSize = '1.6em'
    kont.appendChild(inputElement)
    ...
    //input2.placeholder.style.color = 'red'
    ...
    buton.type = 'button'
    buton.value = 'тест'
    //buton.style.display = 'inline-block !important'
    ...
    buton1.type = 'button'
    //buton1.value= 'тест'
    //buton1.style.display = 'inline-block !important'
    buton1.style.width = '50%'
    buton1.style.color = '#000'
    buton1.style.backgroundColor = '#fff'


    //buton.style.bacground= 'transparent'
    buton1.appendChild(document.createTextNode('Смени'))

    buton1.addEventListener('click', addAndChange, false)
    ...
    //GM_r/egisterMenuCommand( "", retCss)
